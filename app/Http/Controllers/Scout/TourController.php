...
class TourController extends Controller
{
    ...
    public function tour_list()
    {
        ...
        $data['tourList'] = DB::table('tour_list')->where('scout_id',$scout_id)->orderby('created_at', 'DESC')->get();
        return view('scout/tour/tour_list')->with($data);
    }
    ...
    public function view_tour($id)
    {
        ...
        return view('scout/tour/tour_view')->with($data);
    }
