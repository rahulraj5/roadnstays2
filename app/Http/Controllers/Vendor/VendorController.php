...
class VendorController extends Controller
{
    ...
    {
        $data['page_heading_name'] = 'Add Hotel';
        ...
        return view('vendor/hotel/add_hotel')->with($data);
    }

    public function hotel_list()
    {
        $data['page_heading_name'] = 'Hotels';
        // dd(Auth::user()->id);
    ...
    {
        $data['page_heading_name'] = 'Edit Hotel';
        $hotel_id = $id;
        $data['countries'] = DB::table('country')->orderby('name', 'ASC')->get();
        $data['properties'] = DB::table('H1_Hotel_and_other_Stays')->orderby('id', 'ASC')->get();
        $data['services'] = DB::table('H3_Services')->orderby('id', 'ASC')->get();
    ...
    {
        $data['page_heading_name'] = 'View Hotel';
        $hotel_id = $id;
        $data['countries'] = DB::table('country')->orderby('name', 'ASC')->get();
        $data['properties'] = DB::table('H1_Hotel_and_other_Stays')->orderby('id', 'ASC')->get();
        $data['services'] = DB::table('H3_Services')->orderby('id', 'ASC')->get();
        ...
        return view('vendor/hotel/hotel_view')->with($data);
    }
