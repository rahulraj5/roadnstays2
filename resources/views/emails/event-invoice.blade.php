      ...
      <div class="main_h_s" style="padding: 0 10px;max-width: 800px;margin: 0 auto;">
         <div class="main_h_ss" style="max-width:800px;width:100%; background:#fff; padding:15px; background:rgba(243, 243, 243, 0.72);">
            ...
            <div style="width: 100%; padding:17px 20px 20px;margin-bottom: 10px;margin-top: 14px;font-size: 20px;">
               <div style="">
                  <img src="{{url('public/uploads/event_gallery/')}}/{{$order_info->image}}" alt="" width="220px" height="180px" style="border-radius:10px;">
               </div>
               <div style="">
            ...
            <div class="bill_add" style=" display: block; border-top: 1px solid #9999994d;padding:17px 20px 20px; width: 100%;">
               ...
               <strong style="font-weight: 600;color: #000; ">Event Details:</strong></span> 
                                    ...
                                    <td style="padding:5px 10px 5px 0" width="370" align="left">
                                       <table width="100%" cellspacing="0" cellpadding="0">
                                          <tbody>
                                             <tr>
                                                <td>
                                                   <span style="font-family:Helvetica,arial,sans-serif;font-size:15px;display:inline-block;color:#4a4a4a;padding-top:2px">{{$order_info->price}}</span>
                                                </td>
                                             </tr>
                                          </tbody>
                                       </table>
                  ...
                  <tbody>
                                    ...
                                    <td style="padding:5px 10px 5px 0" width="65%" align="left">
                                       <table width="100%" cellspacing="0" cellpadding="0">
                                          <tbody>
                                             <tr>
                                                <td>
                                                   <p style="font-family:Helvetica,arial,sans-serif;font-size:15px;margin:0;padding-top:3px;padding-bottom:3px;color:#4a4a4a">Event is Non-Refundable.</p>
                                                   <br>
                     ...
                     <td style="border-bottom:1px solid #d8d8d8;padding:20px 0px" width="100%">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                           <tbody>
                              <tr>
                                 <td style="font-family:Helvetica,arial,sans-serif;font-weight:bold;font-size:15px;color:#5c5c5c" width="100%" valign="top">***NOTE***: Any increase in the price  due to taxes will be borne by you and payable at the event.
                                 </td>
                              </tr>
                           </tbody>
                        </table>
