    ...
    <div class="main_h_s" style="padding: 0 10px;max-width: 800px;margin: 0 auto;">
        ...
        <div class="main_h_ss" style="max-width:800px;width:100%; background:#fff; padding:15px; background:rgba(243, 243, 243, 0.72);">
                ...
                <div class="bill_add" style="display: block;border-top: 1px solid #9999994d;padding: 22px 10px; border-bottom: 1px solid #9999994d; margin: 0px 0; padding:17px 15px 15px;">
                   ...
                   <strong style="font-weight: 500;color: #000; font-size: 18px;">Start Date:</strong><br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->tour_start_date}}<span style="font-family:Helvetica,arial,sans-serif;font-size:14px;color:#777777"></span></p></span> 
                    
                    <span class="fir_str" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px;">
                   <strong style="font-weight: 500;color: #000; font-size: 18px;">End Date:</strong><br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->tour_end_date}}<span style="font-family:Helvetica,arial,sans-serif;font-size:14px;color:#777777"></span></p></span>
...
Tour Booking Id<br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->id}}</p></span> 
                     
<span class="" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px; color: #9d9595;">
                    
    Total Amount<br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">PKR {{$order_info->tour_price}}/-</p></span> 
                ...
                <span style="width: 100%;display: inline-block;vertical-align: top;padding:10px 15px 10px 15px;margin: 25px 0 15px; font-size: 20px; font-weight: 600; ">
                    Tour Type: {{$order_info->tour_type}}</span>
                    ...
                    <div style="width: 100%; padding:17px 15px 15px; margin-bottom: 10px;margin-top: 14px;font-size: 20px;">
                        ...
                        <div style="width:100%;">
                            <td style="padding:5px" width="100%" align="left">
                                ...
                                <p style="color:#129212;font-size:18px;line-height:20px;margin-top:0;margin-bottom:5px;font-weight:900; font-family:Arial,Helvetica,sans-serif;"><a style="text-decoration: none; color: #126c62; text-transform: uppercase; " href="#">{{$order_info->tour_title}}</a>
                                </p>
                                <p style="font-family:Arial,Helvetica,sans-serif; font-size:14px;margin-top:7px;margin-bottom:0;margin-left:0;margin-right:0;line-height:20px">{{$order_info->address}}, {{$order_info->city}}, India</p>
                                    ...
                                    <p style="font-family:Arial,Helvetica,sans-serif; font-size:14px;margin-top:7px;margin-bottom:0;margin-left:0;margin-right:0">Phone: {{$order_info->contact_number}}, {{$order_info->user_company_number}}</p>
                                ...
                                <p style="font-family:Arial,Helvetica,sans-serif; font-size:14px;margin-top:7px;margin-bottom:0;margin-left:0;margin-right:0">Getting there: <a style="text-decoration: none; color: #126c62;" href="https://maps.google.com?daddr={{$order_info->latitude}},{{$order_info->longitude}}" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://maps.google.com?daddr%3D{{$order_info->latitude}},{{$order_info->longitude}}&amp;source=gmail&amp;ust=1657607876278000&amp;usg=AOvVaw35ZtF9WonT9gFP-ixRdIqi">Show directions</a></p>
                        </td>
                        </div>
                        </div>
