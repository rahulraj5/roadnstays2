         ...
         <div class="main_h_ss" style="max-width:800px;width:100%; background:#fff; padding:15px; background:rgba(243, 243, 243, 0.72);">
            <div style="padding:17px 15px 15px;border:1px solid #fff;background:rgba(243, 243, 243, 0.72);">
               ...
               <div style=" display:block; overflow:hidden">
                  <p style="text-align: center; font-family:Arial,Helvetica,sans-serif;">Mr./Mrs. {{$order_info->first_name}} {{$order_info->last_name}} Booked Tour no.- #{{$order_info->id}}. Please confirm it.</p>
               </div>
            </div>
            ...
            <div class="bill_add" style="display: block;border-top: 1px solid #9999994d;padding: 22px 10px; border-bottom: 1px solid #9999994d; margin: 0px 0; padding:17px 15px 15px;">
               <span class="" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px;">
                  ...
                  <p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->tour_start_date}}<span style="font-family:Helvetica,arial,sans-serif;font-size:14px;color:#777777"></span></p>
               </span>
               <span class="fir_str" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px;">
                  ...
                  <p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->tour_end_date}}<span style="font-family:Helvetica,arial,sans-serif;font-size:14px;color:#777777"></span></p>
               </span>
            </div>
            <div class="bill_add" style="display: block; padding: 22px 10px; border-bottom: 1px solid #9999994d; margin: 0px 0; padding:17px 15px 15px;">
               <span class="" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px; color: #9d9595;">
                  Tour Booking Id<br>
                  <p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->id}}</p>
               </span>
               <span class="" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px; color: #9d9595;">
                  Total Amount<br>
                  <p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">PKR {{$order_info->tour_price}}/-</p>
               </span>
            </div>
            ...
            <div style="width: 100%; padding:17px 15px 15px; margin-bottom: 10px;margin-top: 14px;font-size: 20px;">
               ...
               <div style="width:100%;">
                  <td style="padding:5px" width="100%" align="left">
                     ...
                     <p style="font-family:Arial,Helvetica,sans-serif; font-size:14px;margin-top:7px;margin-bottom:0;margin-left:0;margin-right:0;line-height:20px">{{$order_info->address}}, {{$order_info->city}},</p>
