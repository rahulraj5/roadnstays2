<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                          ...
                          <head>
                             ...
                             <title>Verify your roadNstays account</title>
                                                     ...
                                                     <center>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                                           ...
                                                           <tr>
                                                              ...
                                                              <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;"> <a href="{{ url('/') }}"><img width="137" height="47" src="{{ url('/') }}/resources/assets/img/road-logo.png" alt="logo"></a> </td>
