    ...
    <div class="main_h_s" style="padding: 0 10px;max-width: 800px;margin: 0 auto;">
        ...
        <div class="main_h_ss" style="max-width:800px;width:100%; background:#fff; padding:15px; background:rgba(243, 243, 243, 0.72);">
                ...
                <div style="display: flex; border-bottom:1px solid #8a8a8a94;">
                    <div style="width:30%; float:left;"><img src="{{url('resources/assets/img/road-logo.png')}}" class="logo_im" width="50px;"></div>
                ...
                <div style=" display:block; overflow:hidden">
                    ...
                    <p style="text-align: center; font-family:Arial,Helvetica,sans-serif;">Mr./Mrs. {{$order_info->first_name}} {{$order_info->last_name}} Booked Room no.- #{{$order_info->room_id}}. Please confirm it.</p>
                </div>
        </div>
                ...
                <div class="bill_add" style=" display: block;border-top: 1px solid #9999994d;padding:10px 15px 10px 15px;">
        	       ...
        	       <span class="" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px; color: #6f6f6f;">
                    ...
                    <strong style="font-weight: 600;color: #000; font-size: 20px; padding-top: 0px;">{{$order_info->first_name}} {{$order_info->last_name}}</strong></span> 


                    <span class="" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px; color: #6f6f6f;">
                        <p style="padding-bottom:0px; margin: 0; ">Contact- No.:</p> <br>
                        <strong style="font-weight: 600;color: #000; font-size: 20px; padding-top: 0px;">{{$order_info->contact_number}}</strong></span> 
                ...
                <div class="bill_add" style="display: block;border-top: 1px solid #9999994d;padding: 22px 10px; border-bottom: 1px solid #9999994d; margin: 0px 0; padding:17px 15px 15px;">
                   ...
                   <strong style="font-weight: 500;color: #000; font-size: 18px;">Check in:</strong><br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->check_in}}<span style="font-family:Helvetica,arial,sans-serif;font-size:14px;color:#777777"> 12:00 PM</span></p></span> 
                    
                    <span class="fir_str" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px;">
                   <strong style="font-weight: 500;color: #000; font-size: 18px;">Check-Out:</strong><br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->check_out}}<span style="font-family:Helvetica,arial,sans-serif;font-size:14px;color:#777777"> 12:00 PM</span></p></span>
...
Hotel Booking Id<br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">{{$order_info->id}}</p></span> 
                     
<span class="" style="width: 45%; display: inline-block; vertical-align: top; padding-bottom: 0px; color: #9d9595;">
                    
    Total Amount<br><p style="font-family:Helvetica,arial,sans-serif;font-size:16px;color:#000000;margin:0;padding-top:12px">PKR {{$order_info->total_amount}}/-</p></span> 
                ...
                <span style="width: 100%;display: inline-block;vertical-align: top;padding:10px 15px 10px 15px;margin: 25px 0 15px; font-size: 20px; font-weight: 600; ">
                    Room Type: {{$order_info->name}}</span>
                    ...
                    <div style="width: 100%; padding:17px 15px 15px; margin-bottom: 10px;margin-top: 14px;font-size: 20px;">
                        <div style="width:50%">
                            <img src="https://source.unsplash.com/random/900×700/?hotel,resort,yatch,villa" alt="" width="220px" height="160px" style="border-radius:10px;">
                        </div>
                        <div style="width:100%;">
                            <td style="padding:5px" width="100%" align="left">
                                ...
                                <p style="font-family:Arial,Helvetica,sans-serif; font-size:14px;margin-top:7px;margin-bottom:0;margin-left:0;margin-right:0">Getting there: <a style="text-decoration: none; color: #126c62;" href="https://maps.google.com?daddr={{$order_info->hotel_latitude}},{{$order_info->hotel_longitude}}" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://maps.google.com?daddr%3D{{$order_info->hotel_latitude}},{{$order_info->hotel_longitude}}&amp;source=gmail&amp;ust=1657607876278000&amp;usg=AOvVaw35ZtF9WonT9gFP-ixRdIqi">Show directions</a></p>
                        </td>
                        </div>
                        </div>
                ...
                <span style="width: 95%; display: inline-block; vertical-align: top; padding-bottom: 10px; padding-top:10px ">
                <strong style="font-weight: 600;color: #000; ">Room Details:</strong></span> 
                                        ...
                                        <td style="padding:5px 0" width="370" align="left">
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                             <span style="font-family:Helvetica,arial,sans-serif;font-size:15px;display:inline-block;color:#4a4a4a;padding-top:2px">Room {{$order_info->total_room}}: Adult - {{$order_info->total_member}}, Child - 0   </span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td style="padding:5px 0" width="170" align="left">
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr>
                                                        <td width="30%">
                                                           <span style="font-family:Helvetica,arial,sans-serif;font-weight:bold;font-size:15px;display:inline-block;color:#4a4a4a;padding-right:10px ">Inclusions:</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td style="padding:5px 0" width="370" align="left">
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <span style="font-family:Helvetica,arial,sans-serif;font-size:15px;display:inline-block;color:#4a4a4a;padding-top:2px">@if($order_info->breakfast_price_inclusion == 1)FREE Breakfast , Accommodation @endif</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tbody>
                                    ...
                                    or <a href="#" style="text-decoration:none!important; color: #126c62;     font-weight: 900;" target="_blank">contact@roadnstays.com</a>
                                                  ...
                                                  <p style="color:#4a4a4a;font-family:Helvetica,arial,sans-serif;font-size:15px;line-height:15px;margin-top:0;padding:0">
                                                      ...
                                                      <a href="{{url('/')}}" style="text-decoration:none!important; color: #126c62;     font-weight: 900;" target="_blank" data-saferedirecturl="#">roadnstays.com</a></p>
                                                      <p style="color:#4a4a4a;font-family:Helvetica,arial,sans-serif;font-size:15px;line-height:15px;margin-top:0;padding:0">
                                                          <a href="{{url('/')}}" style="text-decoration:none!important; color: #126c62;     font-weight: 900;" target="_blank" data-saferedirecturl="#">Click here</a> to see booking policies.</p> 
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
