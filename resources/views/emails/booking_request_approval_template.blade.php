         ...
         <div style="background: #fff;padding: 15px;">
            <div style="padding:30px;border:1px solid #fff;background:#eafdfc;">
               ...
               <div style=" display:block; overflow:hidden">
                  <p class="parag">Thank you for the Booking Request</p>
                  <p class="parag">Your Request for the Booking has been Approved!</p>
                  
                  @if(!empty($last_date))
                     <p class="parag">Pay Before Date : {{$last_date ?? ''}}  &  Time : {{$last_time ?? ''}} else Booking will be cancelled </p>
                  @else
                     <p class="parag">Pay Online or on Check in Time }?></p>
                  @endif
                  
                  <p class="parag">You can Check Your Booking Approval Status in Booking List after Login.</p>
