                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @if (!$home_content->isEmpty())
                                        ...
                                        <tr id="row{{ $arr->id }}">
                                            ...
                                            <td><?php if($arr->images != ""){?><img src="{{ url('resources/assets/img') }}/{{ $arr->images }}" style="width: 100px; height: 100px;"><?php } ?></td>
                                            <td>{{ $arr->heading }}</td>
                                            <td style="color:black;">{!! $arr->subheading !!}</td>
                                            

                                            <td class="text-right py-0 align-middle"> 
                                                <div class="btn-group btn-group-sm"> 
                                                   <a href="{{url('/admin/edit_banner')}}/{{ base64_encode($arr->id) }}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
