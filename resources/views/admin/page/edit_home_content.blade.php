      ...
      $(form).ajaxSubmit({
        ...
        success: function (response) {
          ...
          if (response.status == 'success') {
            ...
            setTimeout(function(){window.location.href=site_url+"/admin/banner_management"},1000);
          } else {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <a href="{{url('/admin/banner_management')}}"><i class="right fas fa-angle-left"></i>Back</a>
          </div>
          <div class="col-sm-6">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
              <form  method="POST" id="updateBanner_form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <input type="hidden" name="banner_id" id="banner_id" value="{{ $home_content[0]->id }}">
                  <input type="hidden" name="old_images" id="old_images" value="{{$home_content[0]->images}}">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="d-flex flex-wrap">
                        <div class="image-gridiv">
                          <img src="{{ url('resources/assets/img') }}/{{ $home_content[0]->images }}">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Heading</label>
                      <input type="text" class="form-control" name="heading" id="heading" placeholder="Enter Heading" value="{{ $home_content[0]->heading }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="sub_heading" id="sub_heading" placeholder="Enter Sub Heading">{{ $home_content[0]->subheading }}</textarea>
