      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="row">
            ...
            <div class="col-md-1"><a href="{{ url('/admin/addroom') }}" class="btn btn-block btn-dark">Add</a></div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr id="row{{ $arr->id }}">
                    ...
                    <td>
                      <!-- <a href="{{url('admin/addCopyRoom/')}}/{{ $arr->id }}"> -->
                    ...
                    <td class="text-center py-0 align-middle">
                      ...
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="{{url('/admin/editRoom')}}/{{base64_encode($arr->id)}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt" alt="edit" title="edit"></i></a>
