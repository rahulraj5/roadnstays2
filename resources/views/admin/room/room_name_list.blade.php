...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Room Name List</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Room Name List</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="row">
            ...
            <div class="col-md-1"><a href="{{ url('/admin/addRoomName') }}" class="btn btn-block btn-dark">Add</a></div>
          </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php $i = 1; ?>
                  @foreach ($room_name_list as $arr)
                  <tr id="row{{ $arr->id }}">
                    <td>{{ $i }}</td>
                    <td>{{ $arr->room_name }}</td>
                    <td><a href="{{url('/admin/roomTypeWiseRoomNameList')}}/{{base64_encode($arr->room_type_id)}}" class="btn btn-secondary" style="margin-right: 3px;">{{ $arr->title }}  <i class="fas fa-list"></i></a></td>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="{{url('/admin/editRoomName')}}/{{base64_encode($arr->id)}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
