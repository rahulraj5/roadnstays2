...
<script>
  ...
  $('.toggle-class').on('change', function() {
    ...
    $.ajax({
      ...
      url: "<?php echo url('/admin/changeScoutStatus'); ?>",
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Scout List</li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"><a href="{{ url('/admin/addScout') }}"
                                                ...
                                                <tr id="row{{ $arr->id }}">
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="{{url('/admin/editScout')}}/{{$arr->id}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
                                                            ...
                                                            <!-- <a href="{{url('/admin/editScout')}}/{{base64_encode($arr->id)}}"><i class="fa fa-edit" aria-hidden="true" alt="user" title="user"></i></a>
