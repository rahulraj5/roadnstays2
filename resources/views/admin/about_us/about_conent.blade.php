                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @if (!$about_content->isEmpty())

                                        <?php $i = 1; ?>

                                        @foreach ($about_content as $arr)
                                        ...
                                        <tr id="row{{ $arr->id }}">
                                            ...
                                            <td><?php if($arr->content_image != ""){?><img src="{{ url('resources/assets/img') }}/{{ $arr->content_image }}" style="width: 100px; height: 100px;"><?php } ?></td>
                                            <td>{{ $arr->image_heading }}</td>
                                            <td>{!! $arr->image_subheading !!}</td>
                                            

                                            <td class="text-right py-0 align-middle"> 
                                                <div class="btn-group btn-group-sm"> 
                                                   <a href="{{url('/admin/editAboutContent')}}/{{ base64_encode($arr->id) }}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
