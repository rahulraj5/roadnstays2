...
<script>
  $("#updateBanner_form").validate({
    ...
    submitHandler: function (form) {
      ...
      $(form).ajaxSubmit({
        type: 'POST',
        url: "{{url('/admin/updateAboutBanner')}}",
        data: formData,
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <a href="{{url('/admin/showAboutBanner')}}"><i class="right fas fa-angle-left"></i>Back</a>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Edit About Banner</h3>
          </div>
          ...
          <div class="card-body">
              <form  method="POST" id="updateBanner_form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <input type="hidden" name="banner_id" id="banner_id" value="{{ $banner_images[0]->id }}">
                  <input type="hidden" name="old_images" id="old_images" value="{{$banner_images[0]->images}}">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="d-flex flex-wrap">
                        <div class="image-gridiv">
                          <img src="{{ url('resources/assets/img') }}/{{ $banner_images[0]->images }}">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Heading</label>
                      <input type="text" class="form-control" name="heading" id="heading" placeholder="Enter Heading" value="{{ $banner_images[0]->heading }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Content</label>
                      <textarea class="form-control" name="content1" id="content1" placeholder="Enter Content">{{ $banner_images[0]->sub_heading }}</textarea>
