                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @if (!$chooseus_content->isEmpty())

                                        <?php $i = 1; ?>

                                        @foreach ($chooseus_content as $arr)
                                        ...
                                        <tr id="row{{ $arr->id }}">
                                            ...
                                            <td>{{ $arr->heading }}</td>
                                            <td>{!! $arr->subheading !!}</td>
                                            

                                            <td class="text-right py-0 align-middle"> 
                                                <div class="btn-group btn-group-sm"> 
                                                   <a href="{{url('/admin/editChooseUs')}}/{{ base64_encode($arr->id) }}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
