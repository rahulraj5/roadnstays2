      ...
      $(form).ajaxSubmit({
        ...
        success: function (response) {
          ...
          if (response.status == 'success') {
            ...
            setTimeout(function(){window.location.href=site_url+"/admin/showChooseUs"},1000);
          } else {
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Edit Why Choose Us Content</h3>
          </div>
          ...
          <div class="card-body">
              <form  method="POST" id="updateBanner_form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <input type="hidden" name="banner_id" id="banner_id" value="{{ $about_chooseus[0]->id }}">
                  
                 
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Heading</label>
                      <input type="text" class="form-control" name="heading" id="heading" placeholder="Enter Heading" value="{{ $about_chooseus[0]->heading }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="content1" id="content1" placeholder="Enter Sub Heading">{{ $about_chooseus[0]->subheading }}</textarea>
