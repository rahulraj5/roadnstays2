                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"><a href="{{ url('/admin/add_customer') }}"
                                                ...
                                                <tr id="row{{ $arr->id }}">
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="{{url('/admin/edit_customer')}}/{{$arr->id}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
