                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" id="summernote_remove" name="summernote" disabled>{{(!empty($hotel_info-> hotel_content) ? $hotel_info-> hotel_content : '')}}</textarea>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Vendors</label>
                              <select disabled="disabled" class="form-control select2bs4" name="vendor_id" id="vendor_id" style="width: 100%;">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" id="summernote1_remove" name="hotel_notes" disabled>{{(!empty($hotel_info-> hotel_notes) ? $hotel_info-> hotel_notes : '')}}</textarea>
                              <!-- Place <em>some</em> <u>text</u> <strong>here</strong> -->
                              <!-- </textarea> -->
                            </div>
                          </div>
