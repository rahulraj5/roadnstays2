    ...
    toastDelete.fire({
      ...
      if (e.value === true) {
        ...
        $.ajax({
          ...
          url: "{{url('/admin/deleteHotelAmenityType')}}",
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Amenity Type List</li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"><a href="{{ url('/admin/addHotelAmenityType') }}"
                            ...
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @if (!$hotelAmenityType_list->isEmpty())

                                            <?php $i = 1; ?>

                                            @foreach ($hotelAmenityType_list as $arr)
                                                ...
                                                <tr id="row{{ $arr->id }}">
                                                    ...
                                                    <td><a href="{{url('/admin/viewHotelAmenityList')}}/{{$arr->id}}" class="btn btn-default btn-sm"><i class="fas fa-list"></i>  View</a></td>
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="{{url('/admin/editHotelAmenityType')}}/{{base64_encode($arr->id)}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
