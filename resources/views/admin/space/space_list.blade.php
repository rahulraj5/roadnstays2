...
<script>
  $('.toggle-class').on('change', function() {
    ...
    $.ajax({
      type: "GET",
      dataType: "json",
      url: "<?php echo url('/admin/changeSpaceStatus'); ?>",
      data: {
        'status': status,
        'space_id': space_id,
      },
                  ...
                  <tr id="row{{ $arr->space_id }}">
                    ...
                    <td class="text-center py-0 align-middle">
                      ...
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="{{url('/admin/view-space')}}/{{base64_encode($arr->space_id)}}" class="btn btn-secondary" style="margin-right: 3px;"><i class="fas fa-eye"></i></a>

                        <a href="{{url('/admin/edit-space')}}/{{base64_encode($arr->space_id)}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>

                        <a href="javascript:void(0)" onclick="deleteConfirmation('<?php echo $arr->space_id; ?>');" class="btn btn-danger" style="margin-right: 3px;"><i class="fas fa-trash" alt="user" title="user"></i></a>
