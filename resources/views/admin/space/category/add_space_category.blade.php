...
@section('title', 'Space - Add New Space Category')
...
<script>
  $("#addSpaceCategory_form").validate({
    debug: false,
    rules: {
      space_cat_name: {
        required: true,
    ...
    submitHandler: function (form) {
      ...
      $(form).ajaxSubmit({
        type: 'POST',
        url: "{{url('/admin/submitSpaceCategory')}}",
        data: formData,
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Space Category</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Add Space Category</h3>
