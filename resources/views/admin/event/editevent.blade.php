      ...
      $(form).ajaxSubmit({
        ...
        success: function(response) {
          ...
          if (response.status == 'success') {
            ...
            setTimeout(function() {
              window.location.href = site_url + "/admin/events_list"
            }, 1000);
          } else {
          ...
          <form method="POST" id="updateEvent_form" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Price</label>
                  <input type="text" class="form-control" name="price" id="price" placeholder="Enter price" value="{{$event['price']}}" <?php if ($event['type'] == 'paid') {
                                                                                                                                          echo "";
                                                                                                                                        } else {
                                                                                                                                          echo 'disabled';
                                                                                                                                        } ?>>
