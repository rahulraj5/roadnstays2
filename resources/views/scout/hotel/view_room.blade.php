            ...
            <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2bs4" name="type_of_price" id="type_of_price" style="width: 100%;" disabled>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tax_percentage" id="tax_percentage" placeholder="Enter Taxes in %" value="{{$room_data->tax_percentage}}" readonly>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="cleaning_fee" id="cleaning_fee" placeholder="Enter cleaning fee." value="{{$room_data->cleaning_fee}}" readonly="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="city_fee" id="city_fee" placeholder="Enter city_fee." value="{{$room_data->city_fee}}" readonly="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="earlybird_discount" id="earlybird_discount" placeholder="Enter discount in %." value="{{$room_data->earlybird_discount}}" readonly="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Minimum number of days in advance</label>
                      <input type="text" class="form-control" name="min_days_in_advance" id="min_days_inadvance" placeholder="Enter Minimum No of days." value="{{$room_data->min_days_in_advance}}" readonly="">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 <? if ($room_data->is_guest_allow == 0) {
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="extra_guest_per_night" id="extra_guest_per_night" placeholder="Enter extra guest per night." value="{{$room_data->extra_guest_per_night}}" readonly>
                    </div>
                  </div>
                  <div class="col-md-4 <? if ($room_data->is_guest_allow == 0) {
                                          echo 'd-none';
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="room_size" id="room_size" placeholder="Enter Size in ft2." value="{{$room_data->room_size}}" readonly="">
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="optional_services" id="optional_services" placeholder="Enter optional services" value="{{$room_data->optional_services}}" readonly="">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="outdoor_facilities" id="outdoor_facilities" placeholder="Enter outdoor facilities." value="{{$room_data->outdoor_facilities}}" readonly="">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="extra_people" id="extra_people" placeholder="Enter extra people." value="{{$room_data->extra_people}}" readonly="">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="form-control select2bs4" multiple="multiple" name="amenity[]" id="amenity_{{$value->id}}" data-placeholder="Select Room Amenities" style="width: 100%;" disabled>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>{{$value->name}}</label>
                  <select class="form-control select2bs4" multiple="multiple" name="services[]" id="service_{{$value->id}}" data-placeholder="Select {{$value->name}}" style="width: 100%;" disabled>
                    <!-- <option value="">Select Room Amenities</option> -->
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernoteRemoved" name="description" readonly="">{{$room_data->description}}</textarea>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernote1Removed" name="notes" readonly>{{$room_data->notes}}</textarea>
