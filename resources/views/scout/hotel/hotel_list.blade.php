                                        ...
                                        @if (!$hotelList->isEmpty())
                                            ...
                                            @foreach ($hotelList as $arr)
                                                ...
                                                <tr id="row{{ $arr->hotel_id }}">
                                                    ...
                                                    <td><a href="{{url('/scout/viewHotelRooms')}}/{{$arr->hotel_id}}" class="btn btn-default btn-sm"><i class="fas fa-list"></i>  View</a></td>

                                                    <td class="project-state">

                                                        <input  type="checkbox" class="toggle-class" data-id="{{$arr->hotel_id}}" data-toggle="toggle" data-style="slow" data-onstyle="success" data-size="small" data-on="Active" data-off="InActive" {{ $arr->hotel_status ? 'checked' : '' }} disabled="disabled">
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="{{url('/scout/viewHotel')}}/{{$arr->hotel_id}}" class="btn btn-secondary" style="margin-right: 3px;"><i class="fas fa-eye"></i></a>
