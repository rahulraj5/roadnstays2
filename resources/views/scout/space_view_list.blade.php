...
<link rel="stylesheet" href="https://roadnstays.com/resources/css/style.css">
<!-- summernote -->
  ...
  <section class="content-header">
    ...
    <div class="container-fluid">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <a href="{{url('/scout/spaceList')}}"><i class="right fas fa-angle-left"></i>Back</a>
          <!-- <h1>View Space Details</h1> -->
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        ...
        <div class="card-header">
          ...
          <h3 class="card-title">View Space Details</h3>
