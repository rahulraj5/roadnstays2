...
<script>
  $('select').on("change", function() {
    ...
    $.ajax({
      type: "GET",
      dataType: "json",
      url: "<?php echo url('/scout/changeSpaceBookingStatus'); ?>",
      data: {
        'status': status,
                  ...
                  <tr id="row{{ $arr->id }}">
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="{{url('/scout/view-eventbooking')}}/{{base64_encode($arr->id)}}" class="btn btn-secondary" style="margin-right: 3px;"><i class="fas fa-eye"></i></a>
                      </div>
                    </td>
                  </tr>
                  <?php $i++; ?>
