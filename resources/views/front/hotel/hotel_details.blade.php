     ...
     <section class="user-section detail-section" style="padding-top: 77px; background-color: #f6f6f6;">
        <div class="container-fluid hero-banner">
           <div class="row hero-sec">
              ...
              <div class="thumb">
                 <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-image="{{url('public/uploads/hotel_gallery')}}/{{$gallery->image}}" data-target="#image-gallery">
                    <img class="img-thumbnail" src="{{url('public/uploads/hotel_gallery')}}/{{$gallery->image}}" alt="Another alt text">
                 </a>
              </div>
              @endforeach
           </div>
                 ...
                 <div class="col-md-4 location">
                    ...
                    <div class="parking">
                       <span><i class='bx bxs-parking'></i>
                          ...
                          <?php if ($hotel_data->parking_option == 2) {
                              echo "Paid Parking";
                           } elseif ($hotel_data->parking_option == 1) {
                              echo "Free Parking";
                           } else {
                              echo "No Parking";
                           } ?>
