               ...
               <div class="row event-box-1">
                @foreach($events_data as $event)
                  <div class="col-md-4 box">
                     <div class="img-box"><img src="{{url('/')}}//public/uploads/event_gallery/{{$event->image}}" alt=""><i class='bx bx-heart'  id="heart" ></i></div>
                     ...
                     <a href="{{url('/event_details')}}/{{base64_encode($event->id)}}">Buy Ticket</a>
                  </div>
                @endforeach
                  <!-- <div class="col-md-4 box">
