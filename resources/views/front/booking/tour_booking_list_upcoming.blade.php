...
<script>
    ...
    $('#tab1').on('click', function() {
        document.location.href = site_url + "/user/tourBookingList";
    })
    $('#tab2').on('click', function() {
        document.location.href = site_url + "/user/tourBookingList-upcoming";
    })
    $('#tab3').on('click', function() {
...
<section class="tab-listsec">
    ...
    <div class="container">
        ...
        <div class="tabs">
            ...
            <label for="tab2" id="tab2" class="tabs__label"> <i class='bx bxs-send'></i>Upcoming({{(count($upcomingBookingList->where('tour_end_date', '>=', Carbon\Carbon::today()->format('Y-m-d'))->where('booking_status', '!=' ,'canceled')))}})</label>
                        ...
                        @foreach ($tour_booking_request as $arr)
                            <div class="content">
                                ...
                                <div class="row user-detail-row ">
                                    ...
                                    @else
                                        <div class="col-md-4 user-detail">
                                            <a href="#"><i class='bx bx-check-circle'></i> Cancel Booking Request</a>
                                        </div>
                                    @endif    
                                </div>
                            </div>
