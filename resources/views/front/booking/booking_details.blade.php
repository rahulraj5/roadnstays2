        ...
        <div class="container">
            <div class="row user-detailr">
                ...
                <div class="user-det user-det-2">
                    ...
                    <ul>
                        <li>
                            <i class='bx bx-male'></i>  <h5>Alexender D'volvo <span>28Yrs, Male</span></h5>
                        </li>
                        <li>
                            <i class='bx bx-female' ></i>  <h5>Princess s <span>23Yrs, Female</span></h5>
                        </li>
                        <li>
                            <i class='bx bx-male'></i>  <h5>Oliver <span>12Yrs, Male</span></h5>
                        </li>
                    </ul>
                </div>
