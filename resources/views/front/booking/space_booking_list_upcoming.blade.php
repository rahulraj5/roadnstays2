...
<section class="tab-listsec">
    ...
    <div class="container">
        ...
        <div class="tabs">
            ...
            <label for="tab2" id="tab2" class="tabs__label"> <i class='bx bxs-send'></i>Upcoming({{(count($upcomingBookingList->where('check_out_date', '>=', Carbon\Carbon::today()->format('Y-m-d'))->where('booking_status', '!=' ,'canceled')))}})</label>
