                  ...
                  <div class="tour-body" >
                     <div class="owl-carousel">
                                 ...
                                 <div class="item-card2">
                                    ...
                                    <div class="d-flex mt-4 dtl-t01">
                                       <div class="btm-info">
                                          ...
                                          <p class="mb-1 item-card2-desc"><i class="bx bx-map"></i> {{$trip->city}} - 12 Places</p>
                                       </div>
                        ...
                        <!-- <div class="item">
                           <div class="card mb-0 item-card2-card">
                               <div class="item-card2-img">
                                   <img src="{{url('/')}}/resources/assets/img/tour2.jpg" alt="img" class="cover-image" />
                               </div>
                               <div class="card-body mid-block">
                                   <div class="item-card2">
                                       <div class="item-card2-desc">
                           ...
                           <div class="card mb-0 item-card2-card">
                               <div class="item-card2-img">
                                   <img src="{{url('/')}}/resources/assets/img/tour3.jpg" alt="img" class="cover-image" />
                               </div>
                               <div class="card-body mid-block">
                                   <div class="item-card2">
                                       <div class="item-card2-desc">
                           ...
                           <div class="card mb-0 item-card2-card">
                               <div class="item-card2-img">
                                   <img src="{{url('/')}}/resources/assets/img/tour4.jpg" alt="img" class="cover-image" />
                               </div>
                               <div class="card-body mid-block">
                                   <div class="item-card2">
                                       <div class="item-card2-desc">
                           ...
                           <div class="card mb-0 item-card2-card">
                               <div class="item-card2-img">
                                   <img src="{{url('/')}}/resources/assets/img/tour6.png" alt="img" class="cover-image" />
                               </div>
                               <div class="card-body mid-block">
                                   <div class="item-card2">
                                       <div class="item-card2-desc">
                           ...
                           <div class="card mb-0 item-card2-card">
                               <div class="item-card2-img">
                                   <img src="{{url('/')}}/resources/assets/img/tour8.png" alt="img" class="cover-image" />
                               </div>
                               <div class="card-body mid-block">
                                   <div class="item-card2">
                                       <div class="item-card2-desc">
            ...
            <div class="slick1">
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/8.jpg">
                  </div>
               ...
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/7.jpg">
                  </div>
                  <div class="name-lists">
                     <h3>India</h3>
                     <h6>starting from $5000</h6>
               ...
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/10.jpg">
                  </div>
                  <div class="name-lists">
                     <h3>Europe</h3>
                     <h6>starting from $5000</h6>
               ...
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/9.jpg">
                  </div>
                  <div class="name-lists">
                     <h3>Australia</h3>
                     <h6>starting from $5000</h6>
               ...
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/11.jpg">
                  </div>
                  <div class="name-lists">
                     <h3>America</h3>
                     <h6>starting from $5000</h6>
               ...
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/paris4.jpg">
                  </div>
                  <div class="name-lists">
                     <h3>France</h3>
                     <h6>starting from $5000</h6>
               ...
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/UAE.jpg">
                  </div>
                  <div class="name-lists">
                     <h3>UAE</h3>
                     <h6>starting from $5000</h6>
               ...
               <div class="slide-item">
                  <div class="image-lists">
                     <img src="{{url('/')}}/resources/assets/img/12.jpg">
                  </div>
                  <div class="name-lists">
                     <h3>Japan</h3>
                     <h6>starting from $5000</h6>
            ...
            <div class="slick_best_place">
                <div class="slide-item">
                    <div class="item-card overflow-hidden mb-0">
                            ...
                            <div class="card-image-set text-center overflow-hidden mb-0">
                                <div class="card-img"> <img src="{{url('/')}}/resources/assets/img/london1.jpg" alt="img" class="cover-image"> 
                                </div>
                ...
                <div class="slide-item">
                    <div class="item-card overflow-hidden mb-0">
                                <div class="item-card-desc">
                            <div class="card-image-set text-center overflow-hidden mb-0">
                                <div class="card-img"> <img src="{{url('/')}}/resources/assets/img/germany1.jpg" alt="img" class="cover-image"> 
                                </div>
                                <div class="item-card-text text-left">
                                    <div class="mb-1 d-flex" id="rating-ability-wrapper">
                                                            <label class="control-label" for="rating">
                ...
                <div class="slide-item">
                    <div class="item-card overflow-hidden mb-0">
                                <div class="item-card-desc">
                            <div class="card-image-set text-center overflow-hidden mb-0">
                                <div class="card-img"> <img src="{{url('/')}}/resources/assets/img/austrelia1.jpg" alt="img" class="cover-image"> 
                                </div>
                                <div class="item-card-text text-left">
                                    <div class="mb-1 d-flex" id="rating-ability-wrapper">
                                                            <label class="control-label" for="rating">
                ...
                <div class="slide-item">
                    <div class="item-card overflow-hidden mb-0">
                                <div class="item-card-desc">
                            <div class="card-image-set text-center overflow-hidden mb-0">
                                <div class="card-img"> <img src="{{url('/')}}/resources/assets/img/canada1.jpg" alt="img" class="cover-image"> 
                                </div>
                                <div class="item-card-text text-left">
                                    <div class="mb-1 d-flex" id="rating-ability-wrapper">
                                                            <label class="control-label" for="rating">
