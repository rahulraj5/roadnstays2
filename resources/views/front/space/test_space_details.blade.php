...
<script>
    ...
    // $(".daterange_detail").click(function(e) {
                    ...
                    <div class="form">
                        ...
                        <form action="" id="space_booking_detail_form">
                            ...
                            <div class="select-date reserved daterange_detail">
                                <div class="date">
                                    <p>Check in</p>
                                    <input type="text" id="space_checkin_date" class="daterange_detail" value="{{ $check_in }}" name="space_checkin_date" placeholder="Add Date">
                                ...
                                <div class="date">
                                    <p>Check Out</p>
                                    <input type="text" id="space_checkout_date" class="daterange_detail" value="{{ $check_out }}" name="space_checkout_date" placeholder="Add Date">
