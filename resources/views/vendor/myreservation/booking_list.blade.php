...
<script>
    ...
    // $('#tab1').on('click', function() {
    //     document.location.href = site_url + "/servicepro/space-reservation-list";
    // })
    // $('#tab2').on('click', function() {
    //     document.location.href = site_url + "/servicepro/bookingList-upcoming";
    // })
    // $('#tab3').on('click', function() {
    //     document.location.href = site_url + "/servicepro/hotel-reservation-list";
    // })

    // "/servicepro/hotel-reservation-list"
    // "/servicepro/tour-reservation-list"
    // "/servicepro/space-reservation-list"
    // $('.tab4').on('click', function() {
    //     $(".bread-sec").css('background-color', '#ccc');
    // })
</script>
    ...
    <div class="container">
        ...
        <div class="tabs">
                ...
                <div class="content">
                    <div class="text-detail">
                        ...
                        <div class="btn-detail">
                            <a href="{{ url('/servicepro/hotel-reservation-details') }}/{{ base64_encode($arr->id) }}">View Booking</a>
                    ...
                    <div class="row user-detail-row ">
                        ...
                        <!-- <div class="col-md-3 user-detail" style="text-align:center;">
                            <a href="{{ url('/') }}"><i class='bx bx-download'></i> Download Invoice</a>
                        </div> -->
                    </div>
                </div>
            ...
            <div class="tabs__content">
                ...
                <div class="content cancelled-content">
                    <div class="text-detail">
                        ...
                        <div class="btn-detail">
                            <a href="{{ url('/servicepro/hotel-reservation-cancel-details') }}/{{ base64_encode($arr->id) }}">View Booking</a>
                        </div>
                    </div>
            ...
            <div class="tabs__content">
                ...
                @if (!$room_booking_request->isEmpty())

                @if(count($room_booking_request) > 0)

                @foreach ($room_booking_request as $arr)
                ...
                <div class="content">
                    ...
                    <div class="row user-detail-row ">
                        <div class="col-md-3 user-detail">
                            <p><i class='bx bxs-calendar'></i>FROM</p>
                            <h6>{{ $arr->check_in_date }} <span>{{ $arr->checkin_time }}</span></h6>
                            <!-- <strong>new Delhi</strong> -->
                        </div>
                        <div class="col-md-3 user-detail">
                            <p><i class='bx bxs-calendar'></i>TO</p>
                            <h6>{{ $arr->check_in_date }} <span>{{ $arr->checkout_time }}</span></h6>
                            <!-- <strong>new Delhi</strong> -->
                        </div>
