...
<script>
    $("#cancelbtn").click(function() {
        // alert('shdfsd');
        var form = $("#hotelBookingCancel_form");
        form.validate({
            rules: {
                cancel_reason: {
                    required: true,
        ...
        if (form.valid() === true) {
            ...
            $(form).ajaxSubmit({
                type: 'POST',
                url: site_url + '/servicepro/cancelHotelBooking',
                data: formData,
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        setTimeout(function() {
                            ...
                            window.location.href = site_url + "/servicepro/hotel-reservation-list";
                        }, 1000);
                    } else {
            ...
            <div class="col-md-12 bread-col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/servicepro/hotel-reservation-list') }}">Hotel Booking</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Booking ID: #VXMN{{ $bookingDetails->id }}</li>
                    </ol>
                </nav>
                <h5>Your Hotel booking has completed</h5>
                <div class="id">
                    <div class="id-text">
        ...
        <div class="row user-detailr">
            <div class="col-md-12 user-detailc ">
                <div class="user-det">
                    ...
                    <div class="loc">
                        <div class="da">
                            <h6> <span>CHECK IN</span>{{ date('d M, D' , strtotime($bookingDetails->check_in)) }} </h6>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-cancel">
            ...
            <div class="modal-body modal-textcancel">
                ...
                <div class="cancelmiddle">
                    ...
                    <form action="" id="hotelBookingCancel_form">
                        ...
                        <textarea name="cancel_details" id="" cols="55" rows="4" placeholder="Write from here..."></textarea>
                        <!-- </fieldset>     -->
                    </form>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn cancelbtn" onclick="cancelBookingConfirmation('<?php echo $bookingDetails->id; ?>')" id="cancelbtn">Submit</button>
            </div>
        </div>
    </div>
</div>
