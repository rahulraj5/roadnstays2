...
<script>
    $("#cancelbtn").click(function() {
        ...
        if (form.valid() === true) {
            ...
            $(form).ajaxSubmit({
                type: 'POST',
                url: site_url + '/servicepro/cancelTourBooking',
                data: formData,
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        setTimeout(function() {
                            ...
                            window.location.href = site_url + "/servicepro/tour-reservation-list";
                        }, 1000);
                    } else {
            ...
            <div class="col-md-12 bread-col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/servicepro/tour-reservation-list') }}">Tour Booking</a></li>
        ...
        <div class="row user-detailr">
            <div class="col-md-12 user-detailc ">
                <div class="user-det">
                    ...
                    <div class="down-i">
                        <a style="text-decoration:none;" target="blank" href="{{ url('/servicepro/tourBookingInvoice') }}/{{ base64_encode($bookingDetails->id) }}"><i class='bx bx-download'></i>Download Invoice</a>
                    </div>
