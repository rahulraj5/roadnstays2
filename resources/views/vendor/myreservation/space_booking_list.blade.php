                            ...
                            <div class="content">
                                <div class="text-detail">
                                    ...
                                    <div class="btn-detail">
                                        <a href="{{ url('/servicepro/space-reservation-details') }}/{{ base64_encode($arr->id) }}">View Booking</a>
                    ...
                    @if(count($bookingList->where('booking_status', 'canceled')) > 0)
                        ...
                        <div class="content cancelled-content">
                            <div class="text-detail">
                                ...
                                <div class="btn-detail">
                                    <a href="{{ url('/servicepro/space-reservation-cancel-details') }}/{{ base64_encode($arr->id) }}">View Booking</a>
                                </div>
                            </div>
