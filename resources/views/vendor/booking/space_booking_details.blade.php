                          ...
                          <div class="portlet yellow-crusta box">
                            ...
                            <div class="portlet-body">
                              ...
                              <div class="row static-info">
                                ...
                                <div class="col-md-7 value"> #{{ $bookingList->space_booking_id }}
                              ...
                              <div class="row static-info">
                                ...
                                <div class="col-md-7 value">{{ date('d M Y', strtotime($bookingList->check_in_date)) }}</div>
                              ...
                              <div class="row static-info">
                                ...
                                <div class="col-md-7 value">{{ date('d M Y', strtotime($bookingList->check_out_date)) }}</div>
                          ...
                          <div class="portlet blue-hoki box">
                            ...
                            <div class="portlet-body">
                              <div class="row static-info">
                                ...
                                <div class="col-md-7 value">
                                  @if(isset($vendor_details->first_name)) {{ $vendor_details->first_name }} {{ $vendor_details->last_name }} @else {{ $vendor_details->name }} @endif
                                </div>
                              ...
                              <div class="row static-info">
                                ...
                                <div class="col-md-7 value">
                                  @if(isset($vendor_details->contact_number)) {{ $vendor_details->contact_number }} @else {{ $vendor_details->admin_number }} @endif
                                </div>
              ...
              <div class="invoice p-3 mb-3">
                ...
                <div class="row invoice-info">
                  <div class="col-sm-4 invoice-col">
                    ...
                    <address>
                      <strong>
                        ...
                        @if(isset($vendor_details->name)) {{ $vendor_details->name }} @endif
                      </strong><br>
                      @if(isset($vendor_details->space_address)) {{ $vendor_details->space_address }}@endif
                      @if(isset($vendor_details->admin_address)) {{ $vendor_details->admin_address }}@endif
                      <br>
                      @if(isset($vendor_details->user_city)) {{ $vendor_details->user_city ,}}@endif
                      @if(isset($vendor_details->admin_city)) {{ $vendor_details->admin_city ,}}@endif

                      @if(isset($vendor_details->state_id)) {{ $vendor_details->state_id ,}}@endif
                      @if(isset($vendor_details->admin_state)) {{ $vendor_details->admin_state ,}}@endif

                      @if(isset($vendor_details->postal_code)) {{ $vendor_details->postal_code ,}}@endif
                      @if(isset($vendor_details->admin_postal_code)) {{ $vendor_details->admin_postal_code ,}}@endif

                      @if(isset($vendor_details->vendor_country_name)) {{ $vendor_details->vendor_country_name }}@endif
                      @if(isset($vendor_details->admin_country)) {{ $vendor_details->admin_country }}@endif
                      <br>
                      Phone:
                      @if(isset($vendor_details->contact_number)) {{ $vendor_details->contact_number }}@endif
                      @if(isset($vendor_details->admin_number)) {{ $vendor_details->admin_number }} @endif
                      <br>
                      Email:
                      @if(isset($vendor_details->email)) {{ $vendor_details->email }}@endif
                  ...
                  <div class="col-sm-4 invoice-col">
                    ...
                    <b>Invoice #{{ $bookingList->space_booking_id }}</b><br>
                    <br>
                    <b>Order ID:</b> #{{ $bookingList->space_booking_id }}<br>
                    <b>Payment Due:</b> {{ $bookingList->check_in_date }}<br>
                    ...
                    <table class="table table-striped" id="room_charges">
                      ...
                      <tbody>
                        ...
                        <tr id="row{{ $arr->id }}">
                          ...
                          <td>{{ $arr->check_in_date }}</td>
                          <td>{{ $arr->check_out_date }}</td>
                          <!-- <td id="room_price_val">PKR {{ number_format($arr->price_per_night), 2}}</td> -->
                          <td id="room_price_val">PKR {{ $arr->total_amount }}</td>
                        </tr>
                        <?php $i++; ?>
                ...
                <div class="row">
                  ...
                  <!-- /.col -->
                  <div class="col-6">
                    <p class="lead">Amount Due {{ $bookingList->checkout_hr }}</p>
