<main id="main">
  ...
  <ul class="menu-trig01">
	...
	<li>
	<a href="#" data-toggle="collapse" data-target="#booking" class="collapsed"> <i class='bx bx-grid-vertical'></i> <span class="nav-label"> Booking </span> <i class='bx bx-chevron-right pull-r'></i> </a>
                      <ul class="sub-menu collapse" id="booking">
                        <li class="active"><a href="{{ url('servicepro/bookingList') }}"><i class='bx bx-chevron-left'></i>Booking List</a></li>
                      </ul>
	</li>
