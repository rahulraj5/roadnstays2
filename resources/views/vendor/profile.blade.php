...
<main id="main">
    ...
    <section class="user-section" style="background-color: #f6f6f6;">
    <!-- padding-top: 100px; -->
        <div class="container">
                ...
                <div class="col-md-9">
                    ...
                    <div class="sider-page">
                        ...
                        <div class="top-dash">
                            ...
                            </div> <a href="" data-toggle="modal" data-target="#profileeModal-edit"><button type="button" class="prifle"> <i class='bx bx-edit-alt'></i> Edit</button></a>
...
<div class="modal fade" id="profileeModal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
